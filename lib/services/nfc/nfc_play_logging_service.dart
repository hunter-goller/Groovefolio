...
class NfcPlayLoggingService {
  ...
  Future<NfcPlayLogResult> logResolvedAlbum(
    ...
    final cooldownTimestamp = _elapsed();
    final previous = _lastLoggedAt[normalizedAlbumId];
    if (previous != null &&
        cooldownTimestamp >= previous &&
        cooldownTimestamp - previous < duplicateWindow) {
    ...
    _lastLoggedAt[normalizedAlbumId] = cooldownTimestamp;
    ...
    try {
      ...
      if (_lastLoggedAt[normalizedAlbumId] == cooldownTimestamp) {
